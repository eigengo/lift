...
class MutableMultiPacketTests : XCTestCase {
    ...
    func testBuild() {
        ...
        // 0x00:               0xca 0xb1 0x03 0xt0 0xt1 0xt2 0xt3 (header)
        ...
        XCTAssert(x[h + 0x04] == 0x01, "Bad data 0 1")
        XCTAssert(x[h + 0x05] == 0x02, "Bad data 0 2")
        XCTAssert(x[h + 0x06] == 0x03, "Bad data 0 3")
        // ...
        
        XCTAssert(x[h + _1 + 0x00] == 0x00, "Bad D header 1 size h \(x[h + _1 + 0x00])")
        XCTAssert(x[h + _1 + 0x01] == 0x02, "Bad D header 1 size l \(x[h + _1 + 0x01])")
        // ...
